            ...
            <div class="flex items-center gap-3 ml-auto">
                ...
                <div x-data="{ 
                    ...
                    showToast(n) {
                        ...
                        this.toasts.push({ id, title: n.title, message: n.message, type: n.type, action_url: n.action_url });
                        setTimeout(() => {
                    ...
                    <div class="fixed bottom-4 left-4 z-50 flex flex-col gap-2 pointer-events-none max-w-sm">
                        <template x-for="t in toasts" :key="t.id">
                            <div @click="markAsRead(t)"
                                 class="p-4 bg-white dark:bg-slate-950 border border-slate-200 dark:border-slate-800 rounded-xl shadow-2xl flex items-start gap-3 pointer-events-auto cursor-pointer transform hover:scale-105 transition-all duration-300 border-l-4 border-l-blue-600 animate-slide-in">
