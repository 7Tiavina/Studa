...
<div class="w-full max-w-md bg-slate-900 p-8 rounded-xl border border-slate-800">
    ...
    <form class="space-y-4">
        <div>
            ...
            <input type="email" class="w-full bg-slate-950 border border-slate-700 rounded-lg p-2 text-white" placeholder="email@exemple.com">
        </div>
        <div>
            <label class="block text-sm mb-1">Mot de passe</label>
            <input type="password" class="w-full bg-slate-950 border border-slate-700 rounded-lg p-2 text-white">
        </div>
    ...
    <div class="mt-6 text-center text-sm">
        Pas encore de compte ? <a href="#" class="text-blue-400 hover:underline">S'inscrire</a>
    </div>
</div>
